...
export const ListingBox:React.FC<IBox> = ({img='circle2.jpg', idx}) => {
  return (
    <div className='h-[400px] sxlg:min-w-[30%] sm:min-w-[50%] min-w-[100%] relative rounded-[10px]' key={idx}>
    <div className="right-angle-triangle absolute right-0 top-0 rotate-[90deg] border-b-white border-b-[100px] border-solid "> </div> 
      <img src={img} alt="listing"  className='w-full h-full rounded-[10px]  object-cover pointer-events-none' draggable="false"/>
