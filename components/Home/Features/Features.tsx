  ...
  return (
   <main className='maxWidthWrapper bg-[#f3f6fd] text-[#4b5456] max-xlg:text-center'>
        ...
        <section className='mt-12 flex relative max-xlg:flex-col'>
                  <div className='uppercase flex xlg:flex-col gap-7 text-[17px] basis-[20%] mx-auto max-xlg:mb-10  max-xslg:border-[#7e9999] max-xslg:border max-xslg:p-4 rounded-3xl' >
                     <div className='features-switch'>For Renters</div>
