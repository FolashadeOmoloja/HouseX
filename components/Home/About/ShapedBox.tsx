...
const ShapedBox:React.FC<IProp> = ({background='#c3d4cc',text='satisfied customers',title="17k+"}) => {
  return (
    <div className={`h-[270px] w-[230px] bg-[${background}] relative slanted-div  rounded-2xl  z-1`}>
           <div className={`absolute top-0 right-0  w-[80px] h-[80px] border-t-[80px] border-t-white border-l-[80px] border-l-[${background}] `}></div>
           <div className={`absolute bottom-0 left-0 w-[80px] h-[80px] border-b-[80px] border-b-white border-r-[80px] border-r-[${background}]`}></div>
