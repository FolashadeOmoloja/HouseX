  ...
  return (
    <main className='maxWidthWrapper  text-[#4b5456] max-xlg:text-center'>
         ...
         <section className='mt-20 relative'>
             <span className='text-[#7e9999] absolute left-[-22px] top-1/2 text-[44px] z-10  bg-white'><FaChevronCircleLeft /></span>
              ...
              <span className='text-[#7e9999] absolute right-[-22px] top-1/2 text-[44px] z-10  bg-white'><FaChevronCircleRight /></span>
         </section>
    </main>
  )
}
